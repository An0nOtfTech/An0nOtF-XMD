...
const DEFAULT_SITE = 'awamiproducts.com';
const CONCURRENCY  = 5;
...
async function getStatusLabel(status, respText) {
    ...
    if (rl.includes('otp'))                                             return 'APPROVED ✅';
    return 'DECLINED ❌';
}
        ...
        async func(m, sock, args) {
            ...
            if (args.length === 0) {
                return sock.sendMessage(m.key.remoteJid, {
                    text: `❌ *Usage:* ${prefix}st NUMBER|MM|YY|CVV\n` +
                          `*Example:* ${prefix}st 4111111111111111|12|25|123\n` +
                          `*Custom site:* ${prefix}st 4111111111111111|12|25|123 site.com\n` +
